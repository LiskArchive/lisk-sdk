...
const { ADDITIONAL_DATA } = require('../../helpers/constants');
...
var additionalDataValidCases = [
	...
	{
		input: faker.random.alphaNumeric(ADDITIONAL_DATA.maxLength),
...
var additionalDataInvalidCases = [
	{
		input: `${faker.random.alphaNumeric(ADDITIONAL_DATA.maxLength - 1)}现`,
		description: 'overflowed string',
		expectation: 'string',
	},
	{
		input: faker.random.alphaNumeric(ADDITIONAL_DATA.maxLength + 1),
