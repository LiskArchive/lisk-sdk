...
var additionalDataValidCases = [
	...
	{
		input: randomstring.generate(constants.additionalData.maxLength),
...
var additionalDataInvalidCases = [
	{
		input: randomstring.generate(constants.additionalData.maxLength - 1) + '现',
		description: 'overflowed string',
		expectation: 'string'
	},
	{
		input: randomstring.generate(constants.additionalData.maxLength + 1),
