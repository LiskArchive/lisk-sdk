...
export function theReturnedTableShouldHaveAHeadWithTheObjectDeepNestedKeys() {
	const { returnValue } = this.test.ctx;
...
export function theReturnedTableShouldHaveAHeadWithTheObjectDeepNestedValues() {
	const { returnValue } = this.test.ctx;
