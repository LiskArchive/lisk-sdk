...
describe('DelegatesListSQL', function () {
	...
	describe('checking SQL function generateDelegatesList()', function () {
		...
		it('SQL generateDelegatesList() should raise exception for undefined round', function (done) {
			var round = undefined;
			var delegates = ['1'];
		...
		it('SQL generateDelegatesList() should raise exception for null round', function (done) {
			var round = null;
			var delegates = ['1'];
		...
		it('SQL generateDelegatesList() should raise exception for negative round', function (done) {
			var round = -1;
			var delegates = ['1'];
		...
		it('SQL generateDelegatesList() should raise exception for empty delegates', function (done) {
			var round = 1;
			var delegates = [];
		...
		it('SQL generateDelegatesListCast() should raise exception for empty delegates', function (done) {
			var round = 1;
			var delegates = [];
		...
		it('SQL generateDelegatesList() should raise exception for null delegates', function (done) {
			var round = 1;
			var delegates = null;
