...
describe('httpApi', function () {
	...
	describe('middleware', function () {
		...
		describe('sanitize', function () {
			...
			it('should call req.sanitize');

			describe('when report is not valid', function () {
			...
			describe('when report is valid', function () {
		...
		describe('attachResponseHeader', function () {
			...
			it('should add single header', function () {
				...
				httpApi.middleware.attachResponseHeader('key', 'value', {}, res, function () {
					cbCalled = true;
				});
		...
		describe('attachResponseHeaders', function () {

			it('should add all headers', function () {
		...
		describe('useCache', function () {
			...
			describe('when cache.isReady() is false', function () {
			...
			it('should call cache.getJsonForKey with key');
			...
			describe('when cachedValue is undefined', function () {
				var debugCalled = false;
				var nextCalled = false;
				var resJsonCalled = false;
				var cachedValue = 'cachedValue';
			...
			describe('when error is undefined and cachedValue is defined', function () {
				var debugCalled = false;
				var nextCalled = false;
				var cachedValue = 'cachedValue';
				var req = {
