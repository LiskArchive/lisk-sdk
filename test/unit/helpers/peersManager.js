...
describe('PeersManager', function () {
	...
	describe('add', function () {
		...
		describe('multiple valid entries', function () {
			...
			it('should add multiple entries in peers after multiple valid entries added', function () {
			...
			it('should add multiple entries in addressToNonceMap after multiple valid entries added', function () {
			...
			it('should add multiple entries in nonceToAddressMap after multiple valid entries added', function () {
				expect(Object.keys(peersManager.addressToNonceMap).length).to.equal(2);
		...
		it('should remove old entry when peer\'s nonce changes', function () {
			expect(peersManager.add(validPeer)).to.be.ok;
