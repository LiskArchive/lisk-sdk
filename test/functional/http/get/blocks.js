...
describe('GET /blocks', () => {
 ...
 return blocksEndpoint.makeRequest({ blockId: 'InvalidId' }, 400).then(res => {
 ...
 return blocksEndpoint.makeRequest({ blockId: '9928719876370886655' }, 200).then(res => {
...
return blocksEndpoint.makeRequest({ height: block.blockHeight }, 200).then(res => {
...
return blocksEndpoint.makeRequest({ generatorPublicKey: 'InvalidKey' }, 400).then(res => {
					expectSwaggerParamError(res, 'generatorPublicKey');
				});
});

			it('using correct params should be ok', () => {
 return blocksEndpoint.makeRequest({ generatorPublicKey: block.generatorPublicKey }, 200).then(res => {
 ...
 return blocksEndpoint.makeRequest({ sort: 'height:asc' }, 200).then(res => {
						expectHeightCheck(res);
 ...
 return blocksEndpoint.makeRequest({ sort: 'height:desc' }, 200).then(res => {
						expectHeightCheck(res);
...
return blocksEndpoint.makeRequest({ sort: 'totalAmount:asc' }, 200).then(res => {
						expectHeightCheck(res);
...
return blocksEndpoint.makeRequest({ sort: 'totalAmount:desc' }, 200).then(res => {
						expectHeightCheck(res);
 ...
 return blocksEndpoint.makeRequest({ sort: 'totalFee:asc' }, 200).then(res => {
						expectHeightCheck(res);
...
return blocksEndpoint.makeRequest({ sort: 'totalFee:desc' }, 200).then(res => {
						expectHeightCheck(res);
...
return blocksEndpoint.makeRequest({ sort: 'timestamp:asc' }, 200).then(res => {
						expectHeightCheck(res);
...
return blocksEndpoint.makeRequest({ sort: 'timestamp:desc' }, 200).then(res => {
						expectHeightCheck(res);
