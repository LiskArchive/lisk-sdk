...
return transactionsEndpoint.makeRequest({
 ...
 return transactionsEndpoint.makeRequest({ id: '79fjdfd' }, 400).then(res => {
 ...
 return transactionsEndpoint.makeRequest({ type: transactionTypes.SEND }, 200).then(res => {
					expect(res.body.data).to.not.empty;
...
return transactionsEndpoint.makeRequest({ senderId: '' }, 400).then(res => {
					expectSwaggerParamError(res, 'senderId');
				});
});

			it('using one senderId should return transactions', () => {
 return transactionsEndpoint.makeRequest({ senderId: accountFixtures.genesis.address }, 200).then(res => {
					expect(res.body.data).to.not.empty;
...
return transactionsEndpoint.makeRequest({ senderId: [accountFixtures.genesis.address, accountFixtures.existingDelegate.address] }, 400).then(res => {
					expectSwaggerParamError(res, 'senderId');
				});
});
		});
...
return transactionsEndpoint.makeRequest({ senderPublicKey: '' }, 400).then(res => {
					expectSwaggerParamError(res, 'senderPublicKey');
				});
});

			it('using one senderPublicKey should return transactions', () => {
 return transactionsEndpoint.makeRequest({ senderPublicKey: accountFixtures.genesis.publicKey }, 200).then(res => {
					expect(res.body.data).to.not.empty;
...
return transactionsEndpoint.makeRequest({ senderPublicKey: [accountFixtures.genesis.publicKey, accountFixtures.existingDelegate.publicKey] }, 400).then(res => {
					expectSwaggerParamError(res, 'senderPublicKey');
				});
});
		});
 ...
 return transactionsEndpoint.makeRequest({ recipientId: '' }, 400).then(res => {
					expectSwaggerParamError(res, 'recipientId');
				});
});

			it('using one recipientId should return transactions', () => {
return transactionsEndpoint.makeRequest({ recipientId: accountFixtures.genesis.address }, 200).then(res => {
					expect(res.body.data).to.not.empty;
 ...
 return transactionsEndpoint.makeRequest({ recipientId: [accountFixtures.genesis.address, accountFixtures.existingDelegate.address] }, 400).then(res => {
					expectSwaggerParamError(res, 'recipientId');
				});
});
		});
 ...
 return transactionsEndpoint.makeRequest({ recipientPublicKey: '' }, 400).then(res => {
					expectSwaggerParamError(res, 'recipientPublicKey');
				});
});

			it('using one recipientPublicKey should return transactions', () => {
 return transactionsEndpoint.makeRequest({ recipientPublicKey: accountFixtures.genesis.publicKey }, 200).then(res => {
					expect(res.body.data).to.not.empty;
 ...
 return transactionsEndpoint.makeRequest({ recipientPublicKey: [accountFixtures.genesis.publicKey, accountFixtures.existingDelegate.publicKey] }, 400).then(res => {
					expectSwaggerParamError(res, 'recipientPublicKey');
				});
});
		});
 ...
 return transactionsEndpoint.makeRequest({ blockId: '' }, 400).then(res => {
					expectSwaggerParamError(res, 'blockId');
				});
});
 ...
 return transactionsEndpoint.makeRequest({ height: '' }, 400).then(res => {
					expectSwaggerParamError(res, 'height');
				});
});

			it('using one height should return transactions', () => {
 return transactionsEndpoint.makeRequest({ height: 1 }, 200).then(res => {
					res.body.data.map(transaction => {
...
return transactionsEndpoint.makeRequest({ minAmount: minAmount }, 200).then(res => {
					res.body.data.map(transaction => {
 ...
 return transactionsEndpoint.makeRequest({ maxAmount: maxAmount }, 200).then(res => {
					res.body.data.map(transaction => {
 ...
 return transactionsEndpoint.makeRequest({ fromTimestamp: -1 }, 400).then(res => {
...
return transactionsEndpoint.makeRequest({ toTimestamp: 0 }, 400).then(res => {
 ...
 return transactionsEndpoint.makeRequest({ limit: -1 }, 400).then(res => {
					expectSwaggerParamError(res, 'limit');
				});
});

			it('using limit > 100 should fail', () => {
 return transactionsEndpoint.makeRequest({ limit: 101 }, 400).then(res => {
					expectSwaggerParamError(res, 'limit');
				});
});

			it('using limit = 10 should return 10 transactions', () => {
 return transactionsEndpoint.makeRequest({ limit: 10 }, 200).then(res => {
...
return transactionsEndpoint.makeRequest({ offset: 'one' }, 400).then(res => {
					expectSwaggerParamError(res, 'offset');
				});
});
 ...
 return transactionsEndpoint.makeRequest({ sort: 'amount:asc', minAmount: 100 }, 200).then(res => {
						var values = _.map(res.body.data, 'amount').map(value => { return parseInt(value); });
 ...
 return transactionsEndpoint.makeRequest({ sort: 'amount:desc' }, 200).then(res => {
						var values = _.map(res.body.data, 'amount').map(value => { return parseInt(value); });
 ...
 return transactionsEndpoint.makeRequest({ sort: 'fee:asc', minAmount: 100 }, 200).then(res => {
						var values = _.map(res.body.data, 'fee').map(value => { return parseInt(value); });
 ...
 return transactionsEndpoint.makeRequest({ sort: 'fee:desc' }, 200).then(res => {
						var values = _.map(res.body.data, 'fee').map(value => { return parseInt(value); });
			...
			describe('type', () => {
				it('sorted by fee:asc should be ok', () => {
return transactionsEndpoint.makeRequest({ sort: 'type:asc', minAmount: 100 }, 200).then(res => {
						expect(_(res.body.data).map('type').sortNumbers('asc')).to.be.eql(_.map(res.body.data, 'type'));
					});
});

				it('sorted by fee:desc should be ok', () => {
 return transactionsEndpoint.makeRequest({ sort: 'type:desc' }, 200).then(res => {
 ...
 return transactionsEndpoint.makeRequest({ sort: 'timestamp:asc', minAmount: 100 }, 200).then(res => {
 ...
 return transactionsEndpoint.makeRequest({ sort: 'timestamp:desc' }, 200).then(res => {
...
return transactionsEndpoint.makeRequest({ sort: sortField }, 200).then(res => {
 ...
 return transactionsEndpoint.makeRequest({ sort: 'height:asc' }, 400).then(res => {
					expectSwaggerParamError(res, 'sort');
				});
});
		});
