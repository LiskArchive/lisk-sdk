					...
					Given('a Lisk object that can create transactions', given.aLiskObjectThatCanCreateTransactions, () => {
						Given('the passphrase can be retrieved from its source', given.thePassphraseCanBeRetrievedFromItsSource, () => {
							Given('public keys that should be voted for "1234567812345678123456781234567812345678123456781234567812345678"', given.publicKeysThatShouldBeVotedFor, () => {
								Given('an options object with vote set to "1234567812345678123456781234567812345678123456781234567812345678"', given.anOptionsObjectWithVoteSetTo, () => {
							...
							Given('public keys that should be unvoted for "1234567812345678123456781234567812345678123456781234567812345678"', given.publicKeysThatShouldBeUnvotedFor, () => {
								Given('an options object with unvote set to "1234567812345678123456781234567812345678123456781234567812345678"', given.anOptionsObjectWithUnvoteSetTo, () => {
									When('the action is called with the options', when.theActionIsCalledWithTheOptions, () => {
										Then('it should get the inputs from sources using the Vorpal instance', then.itShouldGetTheInputsFromSourcesUsingTheVorpalInstance);
										Then('it should get the inputs from sources using the passphrase source with a repeating prompt', then.itShouldGetTheInputsFromSourcesUsingThePassphraseSourceWithARepeatingPrompt);
										Then('it should not get the inputs from sources using the second passphrase source', then.itShouldNotGetTheInputsFromSourcesUsingTheSecondPassphraseSource);
						...
						Given('public keys that should be voted for "215b667a32a5cd51a94c9c2046c11fffb08c65748febec099451e3b164452bca", "922fbfdd596fa78269bbcadc67ec2a1cc15fc929a19c462169568d7a3df1a1aa"', given.publicKeysThatShouldBeVotedFor, () => {
							Given('public keys that should be unvoted for "e01b6b8a9b808ec3f67a638a2d3fa0fe1a9439b91dbdde92e2839c3327bd4589", "ac09bc40c889f688f9158cca1fcfcdf6320f501242e0f7088d52a5077084ccba"', given.publicKeysThatShouldBeUnvotedFor, () => {
								...
								Given('an options object with unvote set to "file:path/to/unvotes.txt" and passphrase set to "passphraseSource" and second passphrase set to "secondPassphraseSource"', given.anOptionsObjectWithUnvoteSetToPassphraseSetToAndSecondPassphraseSetTo, () => {
									Given('an error "Unknown data source type." occurs retrieving the inputs from their sources', given.anErrorOccursRetrievingTheInputsFromTheirSources, () => {
										When('the action is called with the options', when.theActionIsCalledWithTheOptions, () => {
											Then('it should reject with the error message', then.itShouldRejectWithTheErrorMessage);
										});
								...
								Given('the passphrase can be retrieved from its source', given.thePassphraseCanBeRetrievedFromItsSource, () => {
									...
									Given('an options object with unvote set to "12345678123456781234567812345678123456781234567812345678123456gg"', given.anOptionsObjectWithUnvoteSetTo, () => {
										When('the action is called with the options', when.theActionIsCalledWithTheOptions, () => {
											Then('it should reject with validation error and message "Public key 12345678123456781234567812345678123456781234567812345678123456gg bytes length differs from the expected 32 bytes for a public key."', then.itShouldRejectWithValidationErrorAndMessage);
										});
									});
									...
									Given('an options object with vote set to "file:path/to/votes.txt" and unvote set to "file:path/to/unvotes.txt"', given.anOptionsObjectWithVoteSetToAndUnvoteSetTo, () => {
										Given('the vote can be retrieved from its source', given.theVoteCanBeRetrievedFromItsSource, () => {
											Given('the unvotes can be retrieved from its source', given.theUnvoteCanBeRetrievedFromItsSource, () => {
												When('the action is called with the options', when.theActionIsCalledWithTheOptions, () => {
													Then('it should get the inputs from sources using the Vorpal instance', then.itShouldGetTheInputsFromSourcesUsingTheVorpalInstance);
													Then('it should get the inputs from sources using the passphrase source with a repeating prompt', then.itShouldGetTheInputsFromSourcesUsingThePassphraseSourceWithARepeatingPrompt);
													Then('it should not get the inputs from sources using the second passphrase source', then.itShouldNotGetTheInputsFromSourcesUsingTheSecondPassphraseSource);
								...
								Given('an options object with unvote set to "file:path/to/unvotes.txt" and passphrase set to "prompt"', given.anOptionsObjectWithUnvoteSetToAndPassphraseSetTo, () => {
									Given('the passphrase can be retrieved from its source', given.thePassphraseCanBeRetrievedFromItsSource, () => {
										Given('the unvote can be retrieved from its source', given.theUnvoteCanBeRetrievedFromItsSource, () => {
											When('the action is called with the options', when.theActionIsCalledWithTheOptions, () => {
												Then('it should get the inputs from sources using the Vorpal instance', then.itShouldGetTheInputsFromSourcesUsingTheVorpalInstance);
								...
								Given('an options object with unvote set to "file:path/to/unvotes.txt" and passphrase set to "file:path/to/my/passphrase.txt" and second passphrase set to "prompt"', given.anOptionsObjectWithUnvoteSetToPassphraseSetToAndSecondPassphraseSetTo, () => {
									Given('the passphrase and the second passphrase can be retrieved from their sources', given.thePassphraseAndSecondPassphraseCanBeRetrievedFromTheirSources, () => {
										Given('the unvote can be retrieved from its source', given.theUnvoteCanBeRetrievedFromItsSource, () => {
											When('the action is called with the options', when.theActionIsCalledWithTheOptions, () => {
												Then('it should get the inputs from sources using the Vorpal instance', then.itShouldGetTheInputsFromSourcesUsingTheVorpalInstance);
