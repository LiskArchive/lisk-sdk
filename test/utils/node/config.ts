...
describe('config node utils', () => {
  describe('#isCacheEnabled', () => {
    ...
    it('should return network cache config', () => {
      ...
      const isEnabled = isCacheEnabled(defaultInstallationPath, NETWORK.MAINNET);
  ...
  describe('#getCacheConfig', () => {
    ...
    it('should return cache config', () => {
      ...
      const cacheConfig = getCacheConfig(defaultInstallationPath, NETWORK.MAINNET);
  ...
  describe('#getDefaultConfig', () => {
    ...
    it('should return default app config', () => {
      return expect(getDefaultConfig(defaultInstallationPath)).to.deep.equal(appConfig);
    });
  });
  ...
  describe('#getNetworkConfig', () => {
    ...
    it('should return network app config', () => {
      return expect(getNetworkConfig(defaultInstallationPath, NETWORK.MAINNET)).to.deep.equal(appConfig);
    });
  });
  ...
  describe('#getConfig', () => {
    ...
    it('should return network app config', () => {
      ...
      return expect(fs.readFileSync).to.be.calledWithExactly(defaultInstallationPath, 'utf8');
    });
  });
});
