...
function sendLISK (params, done) {
	var sendTransaction = node.lisk.transaction.createTransaction(params.recipientId, params.amount, params.secret, params.secondSecret);
	postTransaction(sendTransaction, done);
}
