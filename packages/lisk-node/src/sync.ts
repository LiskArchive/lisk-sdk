...
export class Sync extends EventEmitter{
    ...
    public constructor(blockchain: Blockchain, dpos: DPOS, p2p: P2P, logger: bunyan) {
        super();
    ...
    public async start(): Promise<void> {
        ...
        await this._sync()
        await this._dpos.verifyDownloadedBlock(this._blockchain.lastBlock, this._blockchain.lastBlock);
    ...
    private async _sync(): Promise<void> {
        ...
        this._logger.debug('recived', responseData);
    }
}