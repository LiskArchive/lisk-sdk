...
export const CONSENSUS_STATE_VOTE_WEIGHTS = 'dpos:voteWeights';
export const CONSENSUS_STATE_FORGERS_LIST = 'dpos:forgersList';
export const CHAIN_STATE_DELEGATE_USERNAMES = 'chain:delegateUsernames';
