...
describe('block', () => {
	...
	const sampleBlockJSON = {
		header: {
			...
			assetsRoot: 'b27ca21f40d44113c2090ca8f05fb706c54e87dd',
			...
			id: 'f14104e384546adaba487af56e658188eea07bb534a61b4cbb9ccaee54139b8c',
		},
		assets: [],
		transactions: [],
	};
	...
	beforeEach(() => {
		...
		block = new Block(channel, schema, metadata);
	});
