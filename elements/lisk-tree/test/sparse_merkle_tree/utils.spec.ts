	...
	describe('binaryExpansion', () => {
		const sampleData = [
			...
			},
			{
				...
				buf: Buffer.from('db13be013ca1b0e713280f9bc63017f2a3452391e98b018935e00b65ba559b2527d89250e1c0', 'hex'),
				keyLength: 38,
			},
			{
				...
				buf: Buffer.from('654d9b5e33e28169f710689d4202c3dfd06810f0b87b7248cf8029bb7573dd36c51e57bbb9b4', 'hex'),
				keyLength: 38,
			},
		];

		for (const data of sampleData) {
			it(`should return correct binary string for ${data.keyLength} byte size`, () => expect(data.str).toEqual(binaryExpansion(data.buf, data.keyLength)));
		}
	});
