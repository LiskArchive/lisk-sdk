 ...
 *
 */
// ort * as validMixvoteTransactionScenario from '../fixtures/vote_transaction/vote_transaction_10_upvotes.json';
...
describe('#castVotes transaction', () => {
	...
	it('should be updated or deleted once castVotes design is decided', () => {
