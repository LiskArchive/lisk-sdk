...
describe('#registerMultisignature transaction', () => {
	it('should be updated or deleted once registerMultisignature design is decided', () => {
	...
	// 	it('should have signatures as hex string', () => {
	...
	// 	it('should have same multisignature asset as protocol spec', () => {
	// 		expect(registrationTx.asset).toStrictEqual(
	// 			validMultisigRegistrationTx.asset,
	// 		);
	// 	});

	// 	it('should have signatures matching protocol spec', () => {
	...
	// 	it('should throw when nonce is invalid', () => {
	...
	// 	it('should throw when fee is invalid', () => {
	...
	// 	it('should throw when number of signatures is less than lower limit', () => {
	...
	// 	it('should throw when number of signatures is more than higher limit', () => {
	...
	// 	it('should throw when number of signatures less than mandatory keys', () => {
	...
	// 	it('should throw when number of signatures is bigger than the count of optional and mandatory keys', () => {
	...
	// 	it('should throw error if Network Identifier is empty', () => {
	...
	// 	it('should throw error if duplicate keys are found', () => {
	...
	// 	it('should throw error if repeated keys exists', () => {
	// 		// eslint-disable-next-line prefer-destructuring
	...
	// 	it('should contain only sender signature if passphrses is empty', () => {
	...
	// 	it('should return basic transaction with no passphrases at all', () => {
	// 		(input as any).passphrases = [];
