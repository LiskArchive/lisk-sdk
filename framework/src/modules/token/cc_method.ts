...
export class TokenInteroperableMethod extends BaseCCMethod {
	...
	public async beforeApplyCCM(_ctx: CrossChainMessageContext): Promise<void> {
		// const { ccm } = ctx;
	...
	public async beforeRecoverCCM(_ctx: CrossChainMessageContext): Promise<void> {
		// const { ccm } = ctx;
		// const methodContext = ctx.getMethodContext();
		// if (ccm.fee < BigInt(0)) {
		// 	throw new Error('Fee must be greater or equal to zero.');
	...
	public async beforeSendCCM(_ctx: CrossChainMessageContext): Promise<void> {
		// const { ccm } = ctx;
		// const methodContext = ctx.getMethodContext();
		// if (ccm.fee < BigInt(0)) {
		// 	throw new Error('Fee must be greater or equal to zero.');
