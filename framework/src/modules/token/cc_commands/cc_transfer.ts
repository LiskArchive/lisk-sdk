...
export class CrossChainTransferCommand extends BaseCCCommand {
	 ...
	 *
	 * In this context, you have the opportunity to validate and cache the module config or perform initializations that are intended to occur only once when each node starts.
	 *
