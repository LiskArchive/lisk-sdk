...
class BFTChainDisjointError extends BFTError {
	constructor() {
		super(
			'Violates disjointness condition. If delegate forged a block of higher height earlier and later the block with lower height'
		);
	}
}
...
class BFTLowerChainBranchError extends BFTError {
	constructor() {
		super(
			'Violates the condition that delegate must choose the branch with largest prevotedConfirmedUptoHeight'
		);
	}
}
