 ...
 */
const loadBlocksOffset = async (storage, transactionManager, genesisBlock, toHeight, fromHeight) => {
	const filters = {
	...
	// Normalize blocks
	const blocks = readStorageRows(rows, transactionManager, genesisBlock);
