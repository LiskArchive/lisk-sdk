		...
		return {
			...
			getNodeStatus: async () => ({
				...
				unconfirmedTransactions: {
					ready: this.transactionPool.getCountByQueue('ready') || 0,
					verified: this.transactionPool.getCountByQueue('verified') || 0,
					pending: this.transactionPool.getCountByQueue('pending') || 0,
					validated: this.transactionPool.getCountByQueue('validated') || 0,
					received: this.transactionPool.getCountByQueue('received') || 0,
				},
