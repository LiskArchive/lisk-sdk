...
export const SUBSTORE_PREFIX_VALIDATOR = 0;
export const SUBSTORE_PREFIX_CHAIN = 1;
export const SUBSTORE_PREFIX_NAME = 2;
export const SUBSTORE_PREFIX_SNAPSHOT = 3;
