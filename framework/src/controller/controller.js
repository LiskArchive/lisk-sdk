 ...
 */
function Controller(modules, componentConfig, logger) {
	this.logger = logger;
 ...
 * @async
 */
Controller.prototype.load = async function() {
...
Controller.prototype._setupDirectories = async function() {
 ...
 * @async
 */
Controller.prototype._setupBus = async function() {
 ...
 * @async
 */
Controller.prototype._setupControllerActions = async function() {
	this.channel.action(
		'getComponentConfig',
...
Controller.prototype._loadModules = async function() {
	return Promise.each(Object.keys(this.modules), m =>
		this._loadInMemoryModule(m)
	);
};

Controller.prototype._loadInMemoryModule = async function(alias) {
...
Controller.prototype.unloadModules = async function(modules = null) {
...
Controller.prototype.cleanup = async function(code, reason) {
