 ...
 * @property {Array.<string>} [payloadLength_in]
 ...
 * @property {Array.<string>} [numberOfTransactions_in]
 * @property {string} [previousBlockId]
 * @property {string} [previousBlockId_eql]
 * @property {string} [previousBlockId_ne]
 * @property {Array.<string>} [previousBlockId_in]
 ...
 * @property {Array.<string>} [totalAmount_in]
 * @property {string} [totalFee]
 ...
 * @property {Array.<string>} [totalFee_in]
 * @property {string} [reward]
 ...
 * @property {Array.<string>} [confirmations_in]
 */
