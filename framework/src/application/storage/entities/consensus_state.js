...
const sqlFiles = {
	upsert: 'consensus_state/upsert.sql',
	get: 'consensus_state/get.sql',
	delete: 'consensus_state/delete.sql',
};

class ConsensusState extends BaseEntity {
