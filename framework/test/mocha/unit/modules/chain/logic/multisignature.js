	...
	describe('verify', () => {
		describe('from multisignature.verify tests', () => {
			it('should return error when min value is smaller than minimum acceptable value', done => {
				...
				const multisigRegistration = registerMultisignature({
	...
	describe('objectNormalize', () => {
		describe('min', () => {
			...
			it('should return error when value is a negative integer', async () => {
				...
				const multisigRegistration4 = registerMultisignature({
					passphrase: accountFixtures.genesis.passphrase,
					keysgroup,
					lifetime: 1,
					minimum: 1,
			...
			it('should return error when value is smaller than minimum acceptable value', async () => {
				...
				const multisigRegistration5 = registerMultisignature({
					passphrase: accountFixtures.genesis.passphrase,
					keysgroup,
					lifetime: 1,
					minimum,
			...
			it('should return error when value is greater than maximum acceptable value', async () => {
				...
				const multisigRegistration6 = registerMultisignature({
					passphrase: accountFixtures.genesis.passphrase,
					keysgroup,
					lifetime: 1,
					minimum,
		...
		describe('lifetime', () => {
			it('should return error when value is not an integer', async () => {
				...
				const multisigRegistration8 = registerMultisignature({
					passphrase: accountFixtures.genesis.passphrase,
					keysgroup,
					lifetime: 1,
					minimum: 2,
			...
			it('should return error when value is smaller than minimum acceptable value', async () => {
				...
				const multisigRegistration9 = registerMultisignature({
					passphrase: accountFixtures.genesis.passphrase,
					keysgroup,
					lifetime,
					minimum: 2,
			...
			it('should return error when value is an overflow number', async () => {
				...
				const multisigRegistration11 = registerMultisignature({
					passphrase: accountFixtures.genesis.passphrase,
					keysgroup,
					lifetime: 1,
					minimum: 2,
		...
		describe('keysgroup', () => {
			it('should return error when it is not an array', async () => {
				...
				const multisigRegistration12 = registerMultisignature({
					passphrase: accountFixtures.genesis.passphrase,
					keysgroup,
					lifetime: 1,
					minimum: 2,
			...
			it('should return error when array length is greater than maximum acceptable value', async () => {
				...
				const multisigRegistration14 = registerMultisignature({
					passphrase: accountFixtures.genesis.passphrase,
					keysgroup,
					lifetime: 1,
					minimum: 2,
