...
const BlockLogic = require('../../../../src/modules/chain/blocks/block');
const accountFixtures = require('../../fixtures/accounts');
const slots = require('../../../../src/modules/chain/blocks/block_slots');

const {
	registeredTransactions,
} = require('../../common/registered_transactions');
const InitTransaction = require('../../../../src/modules/chain/interface_adapters/transaction_interface_adapter');
