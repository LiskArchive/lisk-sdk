...
import { BFTParametersCache } from '../../../../src/modules/bft/bft_params';
import {
...
} from '../../../../src/modules/bft/bft_votes';
import { MODULE_ID_BFT, STORE_PREFIX_BFT_PARAMETERS } from '../../../../src/modules/bft/constants';
import { bftParametersSchema, BFTVotes } from '../../../../src/modules/bft/schemas';
...
describe('BFT votes', () => {
	...
	describe('updatePrevotesPrecommits', () => {
		...
		it('should throw error when the latest block is not generated by validators', async () => {
			insertBlockBFTInfo(
				bftVotes,
				createFakeBlockHeader({
					height: 152,
			...
			await expect(updatePrevotesPrecommits(bftVotes, paramsCache)).rejects.toThrow(
				'Invalid state.',
			);
		});
	...
	describe('updateMaxHeightCertified', () => {
		it('should update maxHeightCertified when aggregateCommit is not empty', () => {
			...
			expect(bftVotes.maxHeightCertified).toEqual(152);
		});
