...
// Once https://github.com/LiskHQ/lisk-sdk/pull/5622 is merged this file should be deleted and tests using it should use the lisk-chain exported transaction instead.
...
export class Transaction {
	...
	public validate(): void {
		...
		if (schemaErrors.length > 0) {
			throw new LiskValidationError(schemaErrors as any);
		}
	}
}
