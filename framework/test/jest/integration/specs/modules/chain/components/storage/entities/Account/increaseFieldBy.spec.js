...
describe('storage.entities.Account.increaseFieldBy', () => {
	...
	describe('Given arguments ({publicKey}, "producedBlocks", "1", tx)', () => {
		it('should increase "producedBlocks" property of given account by "1"', async () => {
			// Arrange
			const account = {
	...
	describe('Given arguments ({publicKey_in: []}, "missedBlocks", "1", tx)', () => {
		it('should increase "missedBlocks" property of given account by 1', async () => {
			// Arrange
			const account = {
				address: 'delegateAddress',
				isDelegate: 0,
	...
	describe('Given arguments ({publicKey}, "voteWeight", "Number", tx)', () => {
		it('should increase "voteWeight" property of given account by given value', async () => {
			// Arrange
			const account = {
				address: 'delegateAddress',
				isDelegate: 0,
