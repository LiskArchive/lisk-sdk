...
} = require('../../../../../../../../src/controller/node/synchronizer');
const {
	computeBlockHeightsList,
} = require('../../../../../../../../src/controller/node/synchronizer/utils');

const {
	AbortError,
} = require('../../../../../../../../src/controller/node/synchronizer/errors');

const {
	Sequence,
} = require('../../../../../../../../src/controller/node/utils/sequence');
const {
	Processor,
