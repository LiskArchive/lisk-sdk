...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		exec: {
			...
			coverage: {
				command: 'node_modules/.bin/istanbul cover --dir test/.coverage-unit ./node_modules/.bin/mocha',
				maxBuffer: maxBufferSize
			},
			coverageSingle: {
				command: 'node_modules/.bin/istanbul cover --dir test/.coverage-unit ./node_modules/.bin/mocha $TEST',
				maxBuffer: maxBufferSize
			},
			fetchCoverage: {
