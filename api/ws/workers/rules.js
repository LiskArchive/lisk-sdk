...
function Rules (insert, remove, block) {
	...
	set(this.rules, [[UPDATES.REMOVE], [ON_CONNECTIONS_TABLE.NONCE.NOT_PRESENT], [ON_CONNECTIONS_TABLE.CONNECTION_ID.NOT_PRESENT], [ON_MASTER.NOT_PRESENT]].join('.'), block.bind(null, codes.ALREADY_ADDED));
}
