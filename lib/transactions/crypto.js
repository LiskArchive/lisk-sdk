...
function getBytes(transaction) {
	...
	switch (transaction.type) {
		...
		case 4: // Username
			assetBytes = new Buffer(transaction.asset.username.alias, "utf8");
			assetSize = assetBytes.length;
			break;

		case 5: // Follow
			assetBytes = new Buffer(transaction.asset.contact.address, "utf8");
			assetSize = assetBytes.length;
			break;

		case 8: // Multi-Signature
		...
		case 10: // In Transfer (Dapp Deposit)
