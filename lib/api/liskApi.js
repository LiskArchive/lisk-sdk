...
LiskAPI.prototype.handleSendRequestFailures = function (requestType, options, error) {
	var that = this;
	var type = this.checkRequest(requestType, options);
	...
	if (type !== 'GET') {
		return Promise.resolve({
			...
			message: 'Could not create HTTP request. Please try again.'
		});
	}
...
LiskAPI.prototype.sendRequest = function (requestType, options, callback) {
	...
	return this.sendRequestPromise(requestType, options)
		...
		.catch(this.handleSendRequestFailures.bind(this, requestType, options))
