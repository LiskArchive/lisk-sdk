...
The following is a set of guidelines for contributing to lisky, which
...
[lisky Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are
...
This section guides you through submitting a bug report for lisky.
...
* **Did the problem start happening recently** (e.g. after updating to a new
	version of lisky, Lisk or any other repository) or was this always a
	problem?
* If the problem started happening recently, **can you reproduce the problem in
	an older version of lisky?** What’s the most recent version in which
	the problem doesn’t happen? You can download older versions of lisky
	from [the releases page](https://github.com/LiskHQ/lisky/releases).
...
lisky, including completely new features and minor improvements to
...
* **Include screenshots and animated GIFs** which help you demonstrate the steps
	or point out the part of lisky which the suggestion is related to. You
...
On lisky we are using [Prettier](https://prettier.io/) and
