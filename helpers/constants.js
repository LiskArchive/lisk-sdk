...
const MAX_SHARED_TRANSACTIONS = 100;
const MAX_SIGNATURES_LENGTH = 196 * 256;
const MAX_TRANSACTIONS_PER_BLOCK = 25;
const MAX_VOTES_PER_TRANSACTION = 33;
...
const UNCONFIRMED_TRANSACTION_TIMEOUT = 10800; // 1080 blocks
