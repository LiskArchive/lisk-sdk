...
var TransactionsSql = {
	...
	getOutTransferByIds: 'SELECT "transaction_id", "dapp_id" AS "ot_dapp_id", "out_transaction_id" AS "ot_outTransactionId" FROM outtransfer WHERE "transaction_id" IN (${id:csv})'
};
