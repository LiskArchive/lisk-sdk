...
class BaseEntity {
	...
	/**
	 * Add a virtual field
	 * Virtual fields are fields generated by
	 * using other fields for making calculations
	 * they're not part of the entity when being
	 * persisted.
	...
	addVirtualField(name, extended = false) {
		const extendedOrbasic = extended
			? [VIRTUAL_FIELD_EXTENDED]
			: [VIRTUAL_FIELD_BASIC];
		this.virtualFields[extendedOrbasic][name] = name;
	}
