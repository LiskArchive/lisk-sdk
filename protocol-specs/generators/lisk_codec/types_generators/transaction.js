...
const { BaseTransaction, VoteTransaction, MultisigTransaction } = prepareProtobuffersBaseTransaction();
...
const generateValidTransactionEncodings = () => {
	const input = {
		validBaseTransaction: {
			object: {
				...
				fee: 3156364651,
				senderPublicKey: Buffer.from('8f057d088a585d938c20d63e430a068d4cea384e588aa0b758c68fca21644dbc', 'hex'),
				asset: Buffer.from('f214d75bbc4b2ea89e433f3a45af803725416ec3', 'hex'),
				signatures: [
					Buffer.from('204514eb1152355799ece36d17037e5feb4871472c60763bdafe67eb6a38bec632a8e2e62f84a32cf764342a4708a65fbad194e37feec03940f0ff84d3df2a05', 'hex'),
					Buffer.from('0b6730e5898ca56fe0dc1c73de9363f6fc8b335592ef10725a8463bff101a4943e60311f0b1a439a2c9e02cca1379b80a822f4ec48cf212bff1f1c757e92ec02', 'hex'),
				],
			},
	...
	const validBaseTransactionEncoded = BaseTransaction.encode(input.validBaseTransaction.object).finish();
	const validVoteTransactionEncoded = VoteTransaction.encode(input.validVoteAsset.object).finish();
	const validMultisigTransactionEncoded = MultisigTransaction.encode(input.validMultiSigAsset.object).finish();
	const validMultisigTransactionWithEmptyEncoded = MultisigTransaction.encode(input.validMultiSigAssetWithEmpty.object).finish();
