...
const getAssetBytes = asset => {
	...
	for (const vote of asset.votes) {
		...
		addressBuffer.writeBigUInt64BE(BigInt(vote.delegateAddress.slice(0, -1)));
		buffers.push(addressBuffer);
		const amountBuffer = Buffer.alloc(8);
		amountBuffer.writeBigInt64BE(BigInt(vote.amount));
	...
	const unsignedTransaction = {
		...
		asset: {
			votes: [
				...
				{ delegateAddress: delegateAccounts[1].address, amount: '50000000000' },
				{
		...
		asset: {
			votes: [
				...
				},
				{
					...
					amount: '-20030000000000',
				},
				{
					delegateAddress: delegateAccounts[2].address,
					amount: '-30030000000000',
				},
				{
					delegateAddress: delegateAccounts[3].address,
					amount: '-40030000000000',
				},
				{
					delegateAddress: delegateAccounts[4].address,
					amount: '-50200000000000',
				},
				{
					delegateAddress: delegateAccounts[5].address,
					amount: '-40030000000000',
	...
	const unsignedTransaction = {
		...
		asset: {
			votes: [
				...
				{ delegateAddress: delegateAccounts[5].address, amount: '50000000000' },
				{
					delegateAddress: delegateAccounts[6].address,
					amount: '-40030000000000',
				},
...
const validUpvoteSuite = () => ({
	...
	summary: 'Valid vote transaction which contain 10 upvotes',
	config: {
		network: 'devnet',
	},
...
const validDownvoteSuite = () => ({
	title: 'Valid vote transaction',
	summary: 'Valid vote transaction which contain 10 downvotes',
	config: {
		network: 'devnet',
	},
	runner: 'vote_transaction',
	handler: 'vote_transaction_10_downvotes',
	testCases: generateValidDownvoteTransaction(),
});

const validMixvoteSuite = () => ({
	title: 'Valid vote transaction',
	summary: 'Valid vote transaction which contain 10 upvotes and 10 downvotes',
	config: {
		network: 'devnet',
	},
	runner: 'vote_transaction',
	handler: 'vote_transaction_10_upvotes_and_10_downvotes',
	testCases: generateValidUpvoteAndDownvoteVoteTransaction(),
});
