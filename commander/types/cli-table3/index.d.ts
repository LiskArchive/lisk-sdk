...
/* tslint:disable:readonly-keyword variable-name no-mixed-interface */
...
declare module 'cli-table3' {
	...
	interface CliTable {
		new (options?: CliTable.TableConstructorOptions): CliTable.Table;
		readonly prototype: CliTable.Table;
	}

	const CliTable: CliTable;
