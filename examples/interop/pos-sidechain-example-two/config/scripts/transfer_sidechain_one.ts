...
=======
		`Sent cross chain transfer transaction (amount: ${params.amount.toString()}, recipient: ${params.recipientAddress.toString(
			'hex',
		)}) from sidechain (sidechainID: ${
>>>>>>> d54ee47ef9 (🌱 Add cross chain transfer scripts)
